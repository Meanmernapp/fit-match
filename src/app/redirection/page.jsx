    ...
    <div className="redirect-page text-center h100vh d-flex py-5">
      <div className="m-auto">
        ...
        <div className="section_title my-4">
          <h2>
            <span>Thanks for</span> signing up{" "}
          </h2>
        </div>
        <h6>
          Please check your inbox for an email verification email. You will be
          redirected to the login page after {countdown} seconds.
        </h6>
      </div>
    </div>
  );
